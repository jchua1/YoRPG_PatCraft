...
public class YoRPG {
	...
	//prints out class selection options
	s = "Choose your class: \n";
	s += "\t1: Warrior\n";
	s += "\t2: Mage\n";
	s += "\t3: Rogue\n";
	...
	try {
	    heroClass = Integer.parseInt(in.readLine());
	}
	catch( IOException e ) { }

	//instantiate the player's character based on given number
	if (heroClass <= 1) {
	...
	//prints out information about selected class
	s = pat.about();
	System.out.print( s );
